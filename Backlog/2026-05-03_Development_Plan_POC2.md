...
| S006b2  | Draft validation warnings — non-blocking checks (empty staff, day count, day order, Sat/Sun vs holiday, Mon-Fri vs holiday, staff name); unified message format            | ✅ Accepted 2026-05-08                                                      |
| S006c   | Pre-filled constraints + quality closure — pre-filled cells skipped by algorithm; Sheet link in reply; year_int=None partial validation; V3 cascade fix; T5a fix; readme  | ⏸ ARCH proposed 2026-05-08 — pending Owner review                          |
| S006d   | Production observability — `--health` Google Sheets connectivity probe; webhook per-request logging                                                                        | ⏸ Planned                                                                  |
